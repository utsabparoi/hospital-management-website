...
<div class="float-sm">
    ...
    <div class="fl-fl float-fb concern-logo">
        ...
        <div class="row">
            <div class="col-6">
                <img src="{{ asset('frontend/images/prime.jpeg') }}" style="width:76px; height: 98px;" alt="">
            </div>
            <div class="col-6">
                <img src="{{ asset('frontend/images/prime2.jpg') }}" style="width:76px; height: 98px;" alt="">
            </div>
        </div>
    </div>
        ...
        <div class="auto-container">
            <div class="row">
                ...
                <div class="col-sm-4">
                    ...
                    <div class="count-box">
                        <span class="count-text">Service 2</span>
                        <h4 class="counter-title">Indoor Patient Serve</h4>
                    </div>
                    <div class="count-box">
                        <span class="count-text">Service 3</span>
                ...
                <div class="col-sm-4 last-div">
                    ...
                    <div>
                        ...
                        Insert a video of your website
                    </div>
