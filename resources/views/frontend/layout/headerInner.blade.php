...
<div class="left-sticky-box-mb">
    <div class="row">
        <div class="col-md-5">
            <div class="row">
                <a href="tel:10602">
                    <div class="col-md-2">
                        <lottie-player src="{{ asset('frontend/package/lf20_wmsbdykq.json') }}" background="transparent" speed="1" style="width: 90px; height: 90px; margin:0 0 -20px -26px;" loop autoplay></lottie-player>
                        <!--<img src="images/icons/24hour.png" alt="">-->
                    </div>
                    <div class="col-md-10">
    ...
    <div class="row">
        <div class="col-md-5">
            <div class="row">
                <div class="col-md-2">
                    <lottie-player src="{{ asset('frontend/package/lf20_uDilo5.json') }}" background="transparent" speed="1" style="width: 40px; height: 40px;" loop autoplay></lottie-player>
                    <!--<img src="images/icons/chat-icon.png" alt="">-->
                </div>
                <div class="col-md-10">
                    <p>Chat</p>
