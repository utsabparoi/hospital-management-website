                        ...
                        <div class="main-content-inner">
                                                    ...
                                                    <form  class="form-horizontal" >
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-5 col-sm-5">
                                                                <input class="form-control name" type="text" id="packageName" name="packageName" value="{{$healthPackage->package_name}}">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label col-sm-3 col-sm-3">Package for who<sup class="text-danger">*</sup>
                                                                :</label>
                                                            <div class="col-md-5 col-sm-5">
                                                                <input class="form-control name" type="text" id="packageForWho" name="packageForWho" value="{{$healthPackage->patient}}">
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="col-md-5 col-sm-5">
                                                                @foreach($healthTest as $healthTests)
                                                                    <input type="checkbox" class="testCheckBox" id="{{$healthTests->test_name}}" value="{{$healthTests->test_name}}"
                                                                           @foreach($packageTest as $packageTests)
                                                                           @if($healthTests->test_name == $packageTests->test_name) checked @endif @endforeach>
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label col-sm-3 col-sm-3">Package Cost(BDT)<sup class="text-danger">*</sup>
                                                                :</label>
                                                            <div class="col-md-5 col-sm-5">
                                                                <input class="form-control name" type="number" id="packageCost" name="packageCost" value="{{$healthPackage->package_cost}}">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label col-sm-3 col-sm-3">Discount(%)<sup class="text-danger">*</sup>
                                                                :</label>
                                                            <div class="col-md-5 col-sm-5">
                                                                <input class="form-control name" type="number" id="packageDiscount" name="packageDiscount" value="{{$healthPackage->package_discount}}">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-12 col-sm-12">
                                                                <textarea class="form-control slug ckeditor" id="packageDescription" type="text" name="packageDescription" required="">{{$healthPackage->package_details}}</textarea>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-3 col-xs-8">
                                                                <label>
                                                                    <input name="status" class="ace ace-switch" type="checkbox" id="status" @php if($healthPackage->status == "true"){echo "checked";}  else {echo "";} @endphp >
                                                                    <span class="lbl"></span>
                                                                </label>
                                                            </div>
                                                        </div>
                            ...
                            <script>
                                ...
                                function UpdatePackage() {
                                    let packageId = '{{$healthPackage->id}}';
                                    ...
                                    if(packageName === ""){
                                        ...
                                        let post_url = "/updatePackage";
                                        let allData = new FormData();
                                        allData.append("PackageId", packageId);
