    ...
    <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">Health Package Categories</li>
            </ul><!-- /.breadcrumb -->
        ...
        <div class="page-content">
            ...
            <div class="widget-box">
                ...
                <div class="widget-header">
                    <h4 class="widget-title"> <i class="fa fa-info-circle"></i> Health Package Categories
                    </h4>
                    <span class="widget-toolbar">
                        <!--------------- CREATE---------------->
                        <a href="{{ route('health_package_category.create') }}" class="">
                                ...
                                <div class="table-responsive" style="border: 1px #cdd9e8 solid;">
                                    <table id="dynamic-table"
                                        ...
                                        <tr>
                                            ...
                                            <th width="20%" class="text-center">Package Category Name</th>
                                            <th width="35%" class="text-center">Package Category Description</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="btn-group btn-corner">
                                                            <!--------------- EDIT SLIDER---------------->
                                                                <a href="{{ route('health_package_category.edit', $item->id) }}" role="button"
                                                            ...
                                                            <!--------------- DELETE SLIDER---------------->
                                                                <button type="button"
                                                                    onclick="delete_item(`{{ route('health_package_category.destroy', $item->id) }}`)"
                                    ...
                                    @include('backend.partials._paginate',['data'=> $pkg_category])
