            ...
            <div class="page-content">
                ...
                <div class="widget-box">
                    ...
                    <div class="widget-header">
                        <h4 class="widget-title"> <i class="fa fa-info-circle"></i> Diagnostic Test
                        </h4>
                        <span class="widget-toolbar">
                        <!--------------- CREATE---------------->
                        <a href="{{ route("insertTestForm") }}" class="">
                                        ...
                                        <table id="dynamic-table"
                                            ...
                                            @foreach($allTest as $allTests)
                                                <tr>
                                                    ...
                                                    <td><span class="span">{{$allTests->test_name}}</span></td>
                                                    <td><span class="span">{{$allTests->test_cost}}</span></td>
                                                    <td><span class="span">{{$allTests->test_discount}}%</span></td>
                                                    <td class="text-center">
                                                        <!--------------- STATUS EDIT---------------->
                                                        <div>
                                                            <label>
                                                                <input name="status" class="ace ace-switch" data-id="{{$allTests->id}}" onclick="statusChange(this)" type="checkbox" id="status" onclick="statusChange()" @php if($allTests->status == "true"){echo "checked";}  else {echo "";} @endphp >
                                                                <span class="lbl"></span>
                                                            </label>
                                                        </div>
                                                    </td>
                                                    <td class="text-center">
                                                        ...
                                                        <div class="btn-group btn-corner  action-span ">
                                                            ...
                                                            <a href="testDelete/{{$allTests->id}}" role="button" class="btn btn-xs btn-danger bs-tooltip"
                                                               title="Edit">
