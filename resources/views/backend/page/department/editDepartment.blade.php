                                        ...
                                        <div class="widget-box">
                                            <div class="widget-header">
                                                <h4 class="widget-title">
                                                    <i class="fa fa-plus-circle"></i> <span class="hide-in-sm">Edit Department</span>
                                                </h4>
                                                    ...
                                                    <form  class="form-horizontal" >
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-5 col-sm-5">
                                                                <input class="form-control name" type="text" id="departmentName" name="departmentName" value="{{$department->department_name}}">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-5 col-sm-5">
                                                                <img src="{{$department->department_image}}" alt="" width="400px" height="200px">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-12 col-sm-12">
                                                                <textarea class="form-control slug ckeditor" id="departmentDescription" type="text" name="departmentDescription" required="">{{$department->department_description}}</textarea>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-3 col-xs-8">
                                                                <label>
                                                                    <input name="status" class="ace ace-switch" type="checkbox" id="status" @php if($department->status == "true"){echo "checked";}  else {echo "";} @endphp >
                                                                    <span class="lbl"></span>
                                                                </label>
                                                            </div>
                                                        </div>
            ...
            <script>
                function updateDepartment(){
                    ...
                    if(departmentName === ""){
                        ...
                        let post_url = "/departmentUpdate";
                        let allData = new FormData();
                        allData.append("DepartmentId", departmentId);
