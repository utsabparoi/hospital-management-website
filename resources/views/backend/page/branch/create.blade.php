                                        ...
                                        <div class="widget-box">
                                            <div class="widget-header">
                                                <h4 class="widget-title">
                                                    <i class="fa fa-plus-circle"></i> <span class="hide-in-sm">Create New Branch</span>
                                                </h4>
                                            ...
                                            <div class="widget-body">
                                                <div class="widget-main">
                                                    ...
                                                    <form action="{{ route('website.branch.store') }}" id="Form" method="post" enctype="multipart/form-data">
                                                        @csrf
