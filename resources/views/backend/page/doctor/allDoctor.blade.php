...
@section('content')
                                            ...
                                            @foreach($doctor as $doctors)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <div>
                                                            <label>
                                                                <input name="status" class="ace ace-switch" data-id="{{$doctors->id}}" onclick="statusChange(this)" type="checkbox" id="status" onclick="statusChange()" @php if($doctors->status == "true"){echo "checked";}  else {echo "";} @endphp >
                                                                <span class="lbl"></span>
                                                            </label>
                                                        </div>
                                                    </td>
                                                    <td class="text-center">
                                                        ...
                                                        <div class="btn-group btn-corner  action-span ">
                                                            ...
                                                            <a href="doctorDelete/{{$doctors->id}}" role="button" class="btn btn-xs btn-danger bs-tooltip"
                                                               title="Edit">
    ...
    <script>
        function statusChange(element) {
            let doctor_id = $(element).attr("data-id");
            let post_url = "/doctorStatusChange";
            let allData = new FormData();
            allData.append("ID", doctor_id);
